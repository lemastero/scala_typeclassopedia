...
libraryDependencies ++= Seq(
  ...
  "org.typelevel" %% "cats-effect" % "2.3.3" withSources(),

  // Scalaz
  "org.scalaz"    %% "scalaz-core" % "7.3.3" withSources(),

  // ZIO
  "dev.zio" %% "zio-prelude"  % "1.0.0-RC2" withSources(),
  "dev.zio" %% "zio" % "1.0.4-2" withSources(),

  // algebra
  "org.typelevel" %% "algebra" % "2.2.1" withSources(),
  ...
  "org.scalatest" %% "scalatest" % "3.2.4" % Test withSources(),
