...
libraryDependencies ++= Seq(
  ...
  "org.typelevel" %% "cats-effect" % "2.3.0" withSources(),
  ...
  "dev.zio" %% "zio" % "1.0.3" withSources(),

  // algebra
  "org.typelevel" %% "algebra" % "2.1.0" withSources(),
  ...
  // tofu
  "ru.tinkoff" %% "tofu" % "0.8.0" withSources(),

  // izumi
  "io.7mind.izumi" %% "fundamentals-bio" % "1.0.0" withSources(),
  ...
  "org.scalatest" %% "scalatest" % "3.2.3" % Test withSources(),
