...
/**
  ...
  */
object Pastro {
  def pastro[P[_, _], Q[_, _]](pq: DinaturalTransformation[P, Q])(implicit
      SQ: Strong[Q]
...
object PastroInstances {
  ...
  def profuntorPastro[P[_, _]]: Profunctor[Pastro[P, *, *]] =
    new Profunctor[Pastro[P, *, *]] {
      def dimap[X, W, Y, Z](
          pab: Pastro[P, Y, Z]
      )(ab: X => Y, cd: Z => W): Pastro[P, X, W] = ???
    }
}
